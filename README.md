...
### Technologies used: Nest.js, PrismaORM, Typescript, Jest. Docker, Swagger UI, ESLint, Prettier, Redis, BullMq
...
6. Utilities: request body validation, route tests, email queues, data caching, route rate-limit, logging
